...
int main() {
    unsigned long long int dlugosc = 0, maksliczba = 0, powtorzeniadowykonania = 0, odejmowanie = 1, granica;

    while (scanf("%lld", &dlugosc) != EOF) {
        // unsigned long long int maksliczba=0, powtorzeniadowykonania=0, odejmowanie = 1, 
